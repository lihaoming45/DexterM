...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_path', type=str, default='/remote-home/share/lqt/dataset/dexgraspnet')
    ...
    hand_model = HandModel(
        mjcf_path='/remote-home/lihaoming/haoming/graspd/shadowpth/mjcf/shadow_hand_wrist_free.xml',
        mesh_path='/remote-home/lihaoming/haoming/graspd/shadowpth/mjcf/meshes',
        contact_points_path='/remote-home/lihaoming/haoming/graspd/shadowpth/mjcf/contact_points.json',
        penetration_points_path='/remote-home/lihaoming/haoming/graspd/shadowpth/mjcf/penetration_points.json',
        device=device
    )

    # object model
    object_model = ObjectModel(
        data_root_path='/remote-home/share/lqt/dataset/meshdata',
        batch_size_each=1,
        num_samples=2000, 
        device=device
    )
    ...
    fig.write_html('./shaodowhand_grasp.html')
