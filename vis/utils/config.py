...
def retrieve_cfg(args, use_rlg_config=False):
    ...
    elif args.task == "IsaacGraspSimulator":
        return os.path.join(args.logdir, "shadow_hand_grasp_dexrep_dexgrasp/{}/{}".format(args.algo,args.algo)), "cfg/{}/config.yaml".format(
            args.algo), "cfg/grasp_simulator.yaml"
    else:
        warn_task_name()
...
def get_args(benchmark=False, use_rlg_config=False):
    ...
    #     # {"name": "--algo", "type": str, "default": "ppo1",
    ...
    #     {'name': '--object_code', 'type': str, 'default': 'core-cellphone-ff9e8c139527c8b85f16c469ffeb982e'},
    #     {'name': '--seq_id', 'type': list, 'default': [0, 1, 2],
    #      "help": "Choose an sequdence id for visualization, None means  visualize all the sequence!"},
    #
    # ]
    custom_parameters = [
        {"name": "--test", "action": "store_true", "default": False,
        ...
        {"name": "--headless", "action": "store_true", "default": False,
            "help": "Force display off at all times"},
        {"name": "--viewer_video_record", "default": False,
         "help": "Viewer video save"},
        {"name": "--env_video_record", "default": False,
         "help": "each environment video save"},
        {"name": "--horovod", "action": "store_true", "default": False,
            "help": "Use horovod for multi-gpu training, have effect only with rl_games RL library"},
        {"name": "--task", "type": str, "default": "Humanoid",
            "help": "Can be BallBalance, Cartpole, CartpoleYUp, Ant, Humanoid, Anymal, FrankaCabinet, Quadcopter, ShadowHand, Ingenuity"},
    ...
    # parse arguments
    args = gymutil.parse_arguments(description="Isaac Grasp",custom_parameters=custom_parameters)
